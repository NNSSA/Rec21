...
N_files = 100
directory = "21cmfast_runs/data_T21s_LC_z=10.0_512Mpc_128Cells_10boxes"
output_file = "data_highres/data_LC_z={:.1f}_{:d}Mpc_{:d}Cells_{:d}boxes.h5".format(
